$(document).on('pageinit', '#app', function () {
    ...
    $("#btnConsultivoNuevos1").unbind('click').bind('click', function () {
        $("#div_nuevos_consultivo").html('<center><div class="ui-grid-a"><div class="ui-block-a"><ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Junio</li> </ul> <img src="css/maqueta/14/14_consultivo.jpg" width="100%"> </div> <div class="ui-block-b"><ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Acumulado</li> </ul><img src="css/maqueta/14/14_acumulado.jpg" width="100%"> </div></div> </center>');
        $("#div_nuevos_consultivo").trigger("create");
    });

    $("#btnConsultivoNuevos2").unbind('click').bind('click', function () {
        $("#div_nuevos_consultivo").html('<center><ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Junio</li> </ul> <img src="css/maqueta/14/14_analisis.jpg" width="50%"> </center>');
        $("#div_nuevos_consultivo").trigger("create");
    });
    ...
    $("#btnNuevosEjecutivo2-1").unbind('click').bind('click', function () {
        $("#div_nuevos_ejecutivo").html('<center> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Mix Cartera</li> </ul><img src="css/maqueta/21/21_mix_cartera_1.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Evolución cartera</li> </ul><img src="css/maqueta/21/21_evolucion_de_cartera_2.jpg" width="100%"> </div> </div> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Cartera por canal</li> </ul><img src="css/maqueta/21/21_cartera_por_canal_3.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Cartera por vendedor</li> </ul><img src="css/maqueta/21/21_cartera_por_vendedor_4.jpg" width="100%"> </div> </div> </center> ');
        $("#div_nuevos_ejecutivo").trigger("create");
    });
