$(document).on('pageinit', '#app', function () {
    ...
    $("#btnNuevosEjecutivo1-1").unbind('click').bind('click', function () {
        ...
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Ejecutivo/ Resumen Mensual");
    ...
    $("#btnNuevosEjecutivo1-2-1").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_ejecutivo").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Ejecutivo/ Entregas / Mix");
    ...
    $("#btnNuevosEjecutivo1-2-2").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_ejecutivo").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Ejecutivo/ Entregas / Canales");
        $("#btnNuevosEjecutivo1-2").click();
        botonSelccionado(1, this.id);
    });
    ...
    $("#btnNuevosEjecutivo1-2-3").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_ejecutivo").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Ejecutivo/ Entregas / Vendedor");
        $("#btnNuevosEjecutivo1-2").click();
        botonSelccionado(1, this.id);
    });
    ...
    $("#btnNuevosEjecutivo1-3").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_ejecutivo").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Ejecutivo/ Atípicos");
        botonSelccionado(1, this.id);
    });
    ...
    $("#btnNuevosEjecutivo1-4").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_ejecutivo").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Ejecutivo/ Evolución. Entregas. Pedidos");
        botonSelccionado(1, this.id);
    });
    ...
    $("#btnNuevosEjecutivo2-1-1").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_ejecutivo").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Ejecutivo/ Cartera/ Mix. Evolución");
    ...
    $("#btnNuevosEjecutivo2-1-2").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_ejecutivo").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Ejecutivo/ Cartera/ Canal, Vendedor");
        $("#btnNuevosEjecutivo2-1").click();
        botonSelccionado(1, this.id);
    });
    ...
    $("#btnNuevosEjecutivo2-2-1").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_ejecutivo").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Ejecutivo/ Stock/ Stock");
    ...
    $("#btnNuevosEjecutivo2-2-2").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_ejecutivo").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Ejecutivo/ Stock/ Saldos");
        $("#btnNuevosEjecutivo2-2").click();
        botonSelccionado(1, this.id);
    });
    ...
    $("#btnNuevosEjecutivo2-3").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_ejecutivo").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Ejecutivo/ Calidad");
        botonSelccionado(1, this.id);
    });
    ...
    $("#btnNuevosAnalitico1-1-1").unbind('click').bind('click', function () {
        ...
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B0/ Entregas, Acumulado");
    ...
    $("#btnNuevosAnalitico1-1-2").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_analitico").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B0/ Canales entregas, Instalaciones");
        $("#btnNuevosAnalitico1-1").click();
        botonSelccionado(1, this.id);
    });
    ...
    $("#btnNuevosAnalitico1-1-3").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_analitico").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B0/ Tráfico/ Pedido/ %Cierre, Acumulado");
        $("#btnNuevosAnalitico1-1").click();
        botonSelccionado(1, this.id);
    });
    ...
    $("#btnNuevosAnalitico1-2-1").unbind('click').bind('click', function () {
        ...
        */
        ...
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B1/ Entregas, Acumulado");
    });
    ...
    $("#btnNuevosAnalitico1-2-2").unbind('click').bind('click', function () {
        ...
        */
        ...
        $("#btnNuevosAnalitico1-2").click();
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B1/ Canales entregas, Instalaciones");
    });
    ...
    $("#btnNuevosAnalitico1-2-3").unbind('click').bind('click', function () {
        ...
        */
        ...
        $("#btnNuevosAnalitico1-2").click();
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B1/ Tráfico/ Pedido/ %Cierre, Acumulado");
    });
    ...
    $("#btnNuevosAnalitico1-3-1").unbind('click').bind('click', function () {
        ...
        */
        ...
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B2/ Entregas, Acumulado");
    });
    ...
    $("#btnNuevosAnalitico1-3-2").unbind('click').bind('click', function () {
        ...
        */
        ...
        $("#btnNuevosAnalitico1-3").click();
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B2/ Canales entregas, Instalaciones");
    });
    ...
    $("#btnNuevosAnalitico1-3-3").unbind('click').bind('click', function () {
        ...
        */
        ...
        $("#btnNuevosAnalitico1-3").click();
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analisis/ B2/ Tráfico/ Pedido/ %Cierre, Acumulado");
    });
    ...
    $("#btnNuevosAnalitico1-4-1").unbind('click').bind('click', function () {
        ...
        */
        ...
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B3/ Entregas, Acumulado");
    });
    ...
    $("#btnNuevosAnalitico1-4-2").unbind('click').bind('click', function () {
        ...
        */
        ...
        $("#btnNuevosAnalitico1-4").click();
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B3/ Canales entregas, Instalaciones");
    });
    ...
    $("#btnNuevosAnalitico1-4-3").unbind('click').bind('click', function () {
        ...
        */
        ...
        $("#btnNuevosAnalitico1-4").click();
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B3/ Tráfico/ Pedido/ %Cierre, Acumulado");
    });
    ...
    $("#btnNuevosAnalitico1-5-1").unbind('click').bind('click', function () {
        ...
        */
        ...
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B4/ Entregas, Acumulado");
    });
    ...
    $("#btnNuevosAnalitico1-5-2").unbind('click').bind('click', function () {
        ...
        */
        ...
        $("#btnNuevosAnalitico1-5").click();
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B4/ Canales entregas, Instalaciones");
    });
    ...
    $("#btnNuevosAnalitico1-5-3").unbind('click').bind('click', function () {
        ...
        */
        B0_3();
        $("#btnNuevosAnalitico1-5").click();
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B4/ Tráfico/ Pedido/ %Cierre, Acumulado");
    });
    ...
    $("#btnNuevosAnalitico1-6-1").unbind('click').bind('click', function () {
        ...
        */
        ...
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B5/ Entregas, Acumulado");
    });
    ...
    $("#btnNuevosAnalitico1-6-2").unbind('click').bind('click', function () {
        ...
        */
        ...
        $("#btnNuevosAnalitico1-6").click();
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B5/ Canales entregas, Instalaciones");
    });
    ...
    $("#btnNuevosAnalitico1-6-3").unbind('click').bind('click', function () {
        ...
        */
        ...
        $("#btnNuevosAnalitico1-6").click();
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B5/ Tráfico/ Pedido/ %Cierre, Acumulado");
    });
    ...
    $("#btnNuevosAnalitico1-7-1").unbind('click').bind('click', function () {
        ...
        */
        ...
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B6/ Entregas, Acumulado");
    });
    ...
    $("#btnNuevosAnalitico1-7-2").unbind('click').bind('click', function () {
        ...
        */
        ...
        $("#btnNuevosAnalitico1-7").click();
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B6/ Canales entregas, Instalaciones");
    });
    ...
    $("#btnNuevosAnalitico1-7-3").unbind('click').bind('click', function () {
        ...
        */
        ...
        $("#btnNuevosAnalitico1-7").click();
        botonSelccionado(1, this.id);
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ B6/ Tráfico/ Pedido/ %Cierre, Acumulado");
    });
    ...
    $("#btnNuevosAnalitico2-1-1").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_analitico").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ Vendedor 1/ Ventas, Entregas Mix, Cartera ");
    ...
    $("#btnNuevosAnalitico2-1-2").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_analitico").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Analítico/ Vendedor 1/ Atípicos, Calidad");
        $("#btnNuevosAnalitico2-1").click();
        botonSelccionado(1, this.id);
    });
    ...
    $("#btnNuevosAnalitico2-2-1").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_analitico").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Vendedor 2/ Ventas, Entregas Mix, Cartera");
    ...
    $("#btnNuevosAnalitico2-2-2").unbind('click').bind('click', function () {
        ...
        $("#div_nuevos_analitico").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Vendedor 2/ Atípicos, Calidad");
        $("#btnNuevosAnalitico2-2").click();
        botonSelccionado(1, this.id);
    });
    ...
    $("#btnNuevosAnalitico2-3-1").unbind('click').bind('click', function () {
        $("#div_nuevos_analitico").html('<center> <div class="ui-grid-b"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Ventas</li> </ul><img src="css/maqueta/27/.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Entregas Mix</li> </ul><img src="css/maqueta/28/.jpg" width="100%"> </div> <div class="ui-block-c"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Cartera</li> </ul><img src="css/maqueta/28/.jpg" width="100%"> </div></div> </center>');
        $("#div_nuevos_analitico").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Vendedor 3/ Ventas, Entregas Mix, Cartera ");
    ...
    $("#btnNuevosAnalitico2-3-2").unbind('click').bind('click', function () {
        $("#div_nuevos_analitico").html('<center> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Atípicos</li> </ul><img src="css/maqueta/28/.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Calidad</li> </ul><img src="css/maqueta/28/.jpg" width="100%"> </div></div> </center>');
        $("#div_nuevos_analitico").trigger("create");
        $("#tituloSeccion2").html("<span class='icon-icnoruta'></span>  Concesión/ Vehiculos Nuevos/ <span class='icon-icnotipoanalisis' style='color:#66cc00'></span> Vendedor 3/ Atípicos, Calidad");
        $("#btnNuevosAnalitico2-3").click();
        botonSelccionado(1, this.id);
    });
