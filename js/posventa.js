$(document).on('pageinit', '#app', function () {
    ...
    *************************************************************************************/
    ...
    $("#btnPosventaEjecutivo1-2").unbind('click').bind('click', function () {
        $("#div_ejecutivoPosventa").html('<center> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Facturación</li> </ul> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Junio</li> </ul><img src="css/maqueta/57/57_facturacion_mes.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Acumulado</li> </ul><img src="css/maqueta/57/57_facturacion_acumulado.jpg" width="100%"> </div> </div> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Pasos de Taller</li> </ul> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Junio</li> </ul><img src="css/maqueta/57/57_facturacion_por_paso_mes.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider" id="titulo_2-3">Acumulado</li> </ul><img src="css/maqueta/57/57_facturacion_por_paso_acumulado.jpg" width="100%"> </div> </div> </div> </div> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Horas</li> </ul> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Junio</li> </ul><img src="css/maqueta/57/57_horas_mes.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Acumulado</li> </ul><img src="css/maqueta/57/57_horas_acumulado.jpg" width="100%"> </div> </div> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Facturación por paso</li> </ul> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Junio</li> </ul><img src="css/maqueta/57/57_facturacion_por_paso_mes.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider" id="titulo_2-3">Acumulado</li> </ul><img src="css/maqueta/57/57_facturacion_por_paso_acumulado.jpg" width="100%"> </div> </div> </div> </div> </center>');
        $("#div_ejecutivoPosventa").trigger("create");
    });
    ...
    $("#btnPosventaEjecutivo1-3").unbind('click').bind('click', function () {
        $("#div_ejecutivoPosventa").html('<center> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Facturación</li> </ul> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Junio</li> </ul><img src="css/maqueta/58/58_facturacion_mes.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Acumulado</li> </ul><img src="css/maqueta/58/58_facturacion_acumulado.jpg" width="100%"> </div> </div> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Pasos de Taller</li> </ul> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Junio</li> </ul><img src="css/maqueta/58/58_facturacion_por_paso_mes.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider" id="titulo_2-3">Acumulado</li> </ul><img src="css/maqueta/58/58_facturacion_por_paso_acumulado.jpg" width="100%"> </div> </div> </div> </div> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Horas</li> </ul> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Junio</li> </ul><img src="css/maqueta/58/58_horas_mes.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Acumulado</li> </ul><img src="css/maqueta/58/58_horas_acumulado.jpg" width="100%"> </div> </div> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Facturación por paso</li> </ul> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Junio</li> </ul><img src="css/maqueta/58/58_facturacion_por_paso_mes.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider" id="titulo_2-3">Acumulado</li> </ul><img src="css/maqueta/58/58_facturacion_por_paso_acumulado.jpg" width="100%"> </div> </div> </div> </div> </center>');
        $("#div_ejecutivoPosventa").trigger("create");
    });
    ...
    *************************************************************************************/
    ...
    $("#btnPosventaAnalitico1-4").unbind('click').bind('click', function () {
        $("#div_analiticoPosventa").html('<center> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Junio</li> </ul><img src="css/maqueta/74.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Acumulado / Evolución</li> </ul><img src="css/maqueta/74" width="100%"> </div> </div> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Pesos</li> </ul><img src="css/maqueta/74.jpg" width="100%"> </center> ');
        $("#div_analiticoPosventa").trigger("create");
    });
    ...
    $("#btnPosventaAnalitico2-1").unbind('click').bind('click', function () {
        $("#div_analiticoPosventa").html('<center> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Evolución horas facturadas en mecánica</li> </ul><img src="css/maqueta/78/78_analitico_horas_facturadas_mecanica_1.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Acumulado</li> </ul><img src="css/maqueta/78/78_analitico_horas_facturadas_mecanica_acumulado_2.jpg" width="100%"> </div> </div> <div class="ui-grid-a"> <div class="ui-block-a"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Evolución horas facturadas en carrocería</li> </ul><img src="css/maqueta/79/79_analitico_horas_facturadas_carroceria_1.jpg" width="100%"> </div> <div class="ui-block-b"> <ul data-role="listview" style="margin:5px"> <li data-role="list-divider">Acumulado</li> </ul><img src="css/maqueta/79/79_analitico_horas_facturadas_carroceria_acumulado_2.jpg" width="100%"> </div> </div> </center> ');
        $("#div_analiticoPosventa").trigger("create");
    });
